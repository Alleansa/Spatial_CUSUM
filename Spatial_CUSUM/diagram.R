...
multi_iter<-function(N.grid=100,shift=0,scale=0,times=100,r=1.1,alpha=0.01){
  #generating data
  ...
  detection<-signal_detection(grid.point,times=100)
  ...
  fdr<-FDRMethod(pvalues,alpha=alpha)
  
  res<-c(detection,fdrl$ind,fdr)
